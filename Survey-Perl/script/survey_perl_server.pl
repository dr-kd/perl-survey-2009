...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{SURVEY_PERL_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{SURVEY_PERL_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
survey_perl_server.pl - Catalyst Testserver

=head1 SYNOPSIS

survey_perl_server.pl [options]
